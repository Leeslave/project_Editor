...
public class Button_ADFGVX_QuitVerificationPanel : Button_ADFGVX
{
    protected override void OnMouseDown()
    {
        ...
        if(GameManager.chat_ADFGVX.PlayAsTutorial && GameManager.CurrentMode == ADFGVX.mode.Decoding)//복호화 튜토리얼 중이었음
        {
        ...
        else if(GameManager.chat_ADFGVX.PlayAsTutorial && GameManager.CurrentMode == ADFGVX.mode.Encoding)//암호화 튜토리얼 중이었음
        {
