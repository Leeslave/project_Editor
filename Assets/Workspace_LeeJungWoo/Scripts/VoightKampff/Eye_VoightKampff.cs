...
public class Eye_VoightKampff : MonoBehaviour
{
    ...
    private void RotatePupil(int rotateStartingPos, int rotateEndingPos, bool clockwise)//시작 각도에서 종료 각도까지 지정 방향으로 눈동자 회전
    {
    ...
    private void Surprise()//놀람 애니메이션 재생
    {
    ...
    private void DrawCSign()//C사인을 그립니다
    {
        StartCoroutine(DrawCSign_IE());
    }
    ...
    private void DrawVSign()//V사인을 그립니다
    {
        if (animationCoroutine != null)
            StopCoroutine(animationCoroutine);
    ...
    private void DrawFSign()//F사인을 그립니다
    {
        if (animationCoroutine != null)
            StopCoroutine(animationCoroutine);
    ...
    private void DrawNSign()//N사인을 그립니다
    {
        if (animationCoroutine != null)
            StopCoroutine(animationCoroutine);
    ...
    private void DrawZSign()//Z사인을 그립니다
    {
        if (animationCoroutine != null)
            StopCoroutine(animationCoroutine);
