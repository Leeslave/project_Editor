...
public class AfterDecodingPart : MonoBehaviour
{
    ...
    private Button_DecodeSave button_DecodeSave;
    ...
    private void Start()
    {
        ...
        button_DecodeSave = transform.Find("DecodeSave").GetComponent<Button_DecodeSave>();
    }
    ...
    public InputField GetInputField_Data()//데이터 인풋 필드 반환
    {
        return data;
    }
