...
public class VerificationPanelPart : MonoBehaviour
{
    ...
    private IEnumerator StartEncodeVerificationIEnumerator()//암호화 확인 시작하기
    {
        ...
        if (adfgvx.ReturnEncodeScore())
        {
            ...
            info = "알림 : " + adfgvx.encodeDataSavePart.GetButton_SecurityLevel().GetMarkText() + " '" + adfgvx.encodeDataSavePart.GetInputField_Title().GetInputString() + "'를\n";
        ...
        else
        {
            ...
            info = "경고 : " + adfgvx.encodeDataSavePart.GetButton_SecurityLevel().GetMarkText() + " '" + adfgvx.encodeDataSavePart.GetInputField_Title().GetInputString() + "'를\n";
